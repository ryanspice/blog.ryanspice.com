---
title: "How I Ran the First Local Fusion/Fugu Coding Harness (June 2026)"
seo_title: "The First Local Fusion/Fugu Coding Harness: June 2026 Archive"
slug: "local-fugu-coding-harness-june-2026"
status: "published"
...
summary: "The archived June 2026 version of my local Fusion/Fugu harness, preserved as the historical setup that preceded the GPT-5.6 Sol conductor and three-model remote Fusion panel."
seo_description: "Archived June 2026 build log for the first version of Ryan Spice's local Fusion/Fugu multi-model coding harness."
---

# How to Run a Local Fusion/Fugu Coding Harness

> [!status-brief]
> **Historical setup:** This is the June 2026 version of the harness. The active configuration has since changed substantially. Read [the current GPT-5.6 Sol Fugu/Fusion setup](/local-fugu-coding-harness/) for the model roster, routing rules, verification matrix, and operational commands now in use.
