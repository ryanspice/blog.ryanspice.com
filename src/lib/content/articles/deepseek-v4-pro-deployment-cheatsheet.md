...
accent: "#8f9fff"
image: "/img/articles/deepseek-v4-pro-deployment-cheatsheet/deployment-paths.svg"
image_alt: "Diagram of four DeepSeek V4 Pro integration surfaces — Claude Code, Hermes, direct API, OpenRouter — with a shared rule band: reasoning effort max on agent lanes, thinking enabled, temperature 1.0."
image_credit: "Original diagram by Ryan Spice"
image_source: "/img/articles/deepseek-v4-pro-deployment-cheatsheet/deployment-paths.svg"
